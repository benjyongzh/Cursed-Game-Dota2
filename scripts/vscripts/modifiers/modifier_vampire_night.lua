modifier_vampire_night = class({})
LinkLuaModifier("modifier_vampire_day", "modifiers/modifier_vampire_day", LUA_MODIFIER_MOTION_NONE)

--------------------------------------------------------------------------------

function modifier_vampire_night:IsHidden()
	return false
end

--------------------------------------------------------------------------------

function modifier_vampire_night:IsDebuff()
    return false
end

--------------------------------------------------------------------------------

function modifier_vampire_night:IsPurgable()
	return false
end

--------------------------------------------------------------------------------

function modifier_vampire_night:GetTexture()
	return "night_stalker_hunter_in_the_night"
end

--------------------------------------------------------------------------------

function modifier_vampire_night:AllowIllusionDuplicate()
	return true
end

--------------------------------------------------------------------------------

function modifier_vampire_night:OnCreated()
...
function modifier_vampire_night:AsymptotePointValue(startvalue, maxvalue, factor, point_in_time)
	local a = startvalue
	local b = maxvalue
...
function modifier_vampire_night:OnRefresh(kv)    
    -- get stats from customnettables. made in addon_game_mode
    local mytable = CustomNetTables:GetTableValue("cursed_stats", "0")
...
function modifier_vampire_night:OnDestroy()
    if IsServer() then
        local vampire = self:GetParent()
...
function modifier_vampire_night:OnIntervalThink()
    if IsServer() then
        if GameRules:IsDaytime() then
            self:Destroy()
            self:GetParent():AddNewModifier(self:GetParent(), nil, "modifier_vampire_day", {})
        end
    end
end
...
function modifier_vampire_night:DeclareFunctions()
	local funcs = {
...
function  modifier_vampire_night:CheckState()
	local state = {
...
function modifier_vampire_night:GetModifierBaseAttack_BonusDamage()
    return self.bonus_damage
end

--------------------------------------------------------------------------------

function modifier_vampire_night:GetModifierAttackSpeedBonus_Constant()
    return self.bonus_atk_speed
end

--------------------------------------------------------------------------------

function modifier_vampire_night:GetModifierMoveSpeedOverride()
    return self.abs_ms
end

--------------------------------------------------------------------------------

function modifier_vampire_night:GetBonusNightVision()
    return self.bonus_nightvision
end

--------------------------------------------------------------------------------

function modifier_vampire_night:GetModifierModelChange()
	return VAMPIRE_3D_MODEL
end

--------------------------------------------------------------------------------

function modifier_vampire_night:GetAttackSound()
	return "Hero_Nightstalker.Attack"
end

--------------------------------------------------------------------------------

function modifier_vampire_night:GetModifierIgnoreMovespeedLimit()
    return 1
end

--------------------------------------------------------------------------------

function modifier_vampire_night:GetModifierProjectileName()
    return ""
end

--------------------------------------------------------------------------------

function modifier_vampire_night:GetModifierExtraHealthBonus()
	return self.extra_hp
end

--------------------------------------------------------------------------------

function modifier_vampire_night:GetModifierConstantManaRegen()
